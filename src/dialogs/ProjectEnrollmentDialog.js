...
const mapStateToPropsBeneficiary = (state) => ({
  fetchingBeneficiaries: state.projectSocialProtection.fetchingProjectEligibleBeneficiaries,
...
const mapStateToPropsGroupBeneficiary = (state) => ({
  fetchingBeneficiaries: state.projectSocialProtection.fetchingProjectEligibleGroupBeneficiaries,
  submittingMutation: state.projectSocialProtection.submittingMutation,
  mutation: state.projectSocialProtection.mutation,
});
