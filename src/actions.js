...
function formatProjectGQL(project) {
  ...
  // An explicitly cleared known place must be sent as an empty string because it
  // is part of the MIS-generated project name.
  return `
    ...
    ${Object.prototype.hasOwnProperty.call(project || {}, 'knownPlace') ? `knownPlace: "${formatGQLString(project.knownPlace || '')}"` : ''}
