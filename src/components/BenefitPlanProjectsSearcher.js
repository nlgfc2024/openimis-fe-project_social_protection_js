...
function BenefitPlanProjectsSearcher({
  ...
  const headers = () => {
    const baseHeaders = [
      ...
      'project.assignedBeneficiariesCount',
      'project.workingDays',
  ...
  const exportFieldsColumns = {
    ...
    assigned_beneficiaries_count: formatMessage(intl, MODULE_NAME, 'project.assignedBeneficiariesCount'),
  ...
  const sorts = () => [
    ...
    ['assignedBeneficiariesCount', true],
    ['workingDays', true],
    ['location', true],
    ['location', true],
    ['microCatchment', true],
